 ...
 *
 * Toute la traduction littérale de l'ASM repose sur cette classe :
 ...
 *  - chaque variable BSS/DATA est une adresse allouée ici (voir ab3d2.bss.*, ab3d2.data.*).
 *
...
public final class Mem {
    ...
    /** Lit une chaîne C (terminée par 0) — pour les noms de fichiers du GLF, etc. */
