...
/**
 * Police bitmap 8x8 pour l'UI. Utilise une police intégrée
 * (Commodore/Amiga-like) ou génère une grille ASCII.
 *
 * Les vraies polices AB3D2 sont des bitmaps 8x8 encodés dans les assets. On
 * fournit un fallback procédural en attendant.
 *
...
public class BitmapFont {
    ...
    /**
     * Construit un atlas 8x8 procédural. On encode les glyphes de base en
     * tableaux de bits (style Commodore 64).
     */
    ...
    /**
     * Retourne (ou crée) un atlas teinté pour la couleur donnée. Simple : on
     * tinte l'atlas blanc à la couleur voulue.
     */
